<x-app-layout>
    ...
    <div id="qr-modal" class="wa-modal hidden">
        <div class="wa-modal-box" style="border-radius: 16px; padding: 24px; max-width: 360px; width: 100%; text-align: center;">
            ...
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 230px; margin-bottom: 16px;">
                <div id="qr-loading-spinner" style="display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 12px; width: 220px; height: 220px; border-radius: 12px; border: 2px dashed var(--cp); background: rgba(0,0,0,0.03);">
                    <svg style="width: 36px; height: 36px; color: var(--cp); animation: spin 1s linear infinite;" fill="none" viewBox="0 0 24 24">
                        <circle style="opacity: 0.25;" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path style="opacity: 0.75;" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
                    <span style="font-size: 12px; font-weight: 600; color: var(--cp);">Generating QR Code...</span>
                </div>
                <img id="qr-code-img" src="" alt="WhatsApp QR Code" style="display: none; width: 220px; height: 220px; border-radius: 12px; border: 2px solid var(--cp);">
            </div>
